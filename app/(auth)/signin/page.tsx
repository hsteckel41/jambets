    ...
    <div className="min-h-dvh bg-[#09090B] flex flex-col items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="gradient-border p-6">
          ...
          <p className="text-white/40 text-sm mb-6">Sign in to write lines, call sets, and settle scores.</p>
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 bg-white text-black font-semibold py-3 px-4 rounded-lg hover:bg-white/90 transition-colors"
            >
